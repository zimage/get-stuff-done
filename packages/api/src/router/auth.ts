...
import { loginWithGoogleInputSchema, refreshInputSchema } from "@gsd/validation";
...
export const authRouter = router({
  loginWithGoogle: publicProcedure.input(loginWithGoogleInputSchema).mutation(async ({ ctx, input }) => {
